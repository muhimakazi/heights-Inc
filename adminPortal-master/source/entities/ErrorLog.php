...
class ErrorLog
{
    ...
    public function setIncidentPageURL($incident_page_url)
    {
        $this->incident_page_url = $incident_page_url;
    }

    public function getIncidentPageURL()
    {
        return $this->incident_page_url;
    }
    ...
    public function getLogCode()
    {
        ...
        $code = "ELG" . Time::getYearIn2Digits() . "" . Time::getCurrentMonth() . "" . $prefix . "" . $rows;
    ...
    {
        try {
            $sql = "INSERT INTO " . $this->_Table . "(log_code, flag, log_date, log_time, incident_page_url, operation, log_message, active_user, device_details, added_on) VALUES(?,?,?,?,?,?,?,?,?,?)";
    ...
    public function getErrorLogs($selection, $search_query = '', $order = '', $limit = '')
    {
        $countryList = array();
