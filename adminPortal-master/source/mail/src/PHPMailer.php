...
class PHPMailer
{
     ...
     * @var string
     */
    protected $MIMEHeader = 'Content-Type: text/html; charset=utf-8';
     ...
     * @var string
     */
    protected $mailHeader = 'Content-Type: text/html; charset=utf-8';
    ...
    public function preSend()
    {
        ...
        try {
            ...
            $this->mailHeader = 'Content-Type: text/plain; charset=utf-8';
            ...
            $this->MIMEHeader = 'Content-Type: text/html; charset=utf-8';
