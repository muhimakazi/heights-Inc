...
<!-- Peity -->
<script src="<?php linkto('js/plugins/peity/jquery.peity.min.js'); ?>"></script>
<script src="<?php linkto('js/demo/peity-demo.js'); ?>"></script>
...
<!-- jQuery UI -->
<script src="<?php linkto('js/plugins/jquery-ui/jquery-ui.min.js'); ?>"></script>

<!-- GITTER -->
<script src="<?php linkto('js/plugins/gritter/jquery.gritter.min.js'); ?>"></script>

<!-- Sparkline -->
<script src="<?php linkto('js/plugins/sparkline/jquery.sparkline.min.js'); ?>"></script>

<!-- Sparkline demo data  -->
<script src="<?php linkto('js/demo/sparkline-demo.js'); ?>"></script>

<!-- ChartJS-->
<script src="<?php linkto('js/plugins/chartJs/Chart.min.js'); ?>"></script>

<!-- Toastr -->
<script src="<?php linkto('js/plugins/toastr/toastr.min.js'); ?>"></script>
...
$(document).ready(function() {
    setTimeout(function() {
        ...
        // toastr.success('Responsive Admin panel', 'Cube communications');
