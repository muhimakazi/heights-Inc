$(document).ready(function() {
    ...
    $(function(){
        $.each(options, function (i, item) {
            $("#residence_country").append("<option value='"+item.text+"'>" + item.text + "</option>");
            $("#citizenship").append("<option value='"+item.text+"'>" + item.text + "</option>");
            $("#organisation_country").append("<option value='"+item.text+"'>" + item.text + "</option>");
        });
    });
