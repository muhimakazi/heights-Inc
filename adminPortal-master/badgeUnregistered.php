			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" id="printable">
				...
				?>
					<div class="card card-profile">
						...
						<div class="card-body text-center" style="padding-top: 140px!important;">
							...
							<div class="partners" style="margin-top: 110px!important;">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><img src="<?php linkto('data_system/img/awf-logo-white.jpg'); ?>"></div>
							</div>
						</div>
					</div>
