                                    ...
                                    <div class="padding">
                                        ...
                                        <div class="card-profile">
                                            <div class="card-header">
                                                <img src="https://bal.torusguru.com/img/logo.png" style="width: 20%" />
                                                <!-- <img src="<?=DN?>/img/cube-logo.png"/> -->
                                            </div>
                                            <div class="card-body">
                                                <p id="partName">Delegate Name</p>
                                                <p class="desi"><span id="orgName">Organisation</span><br>
                                                    <span id="country">Country</span><br><br>
                                                    <span id="pass_type" style="color: #f06624;">Pass Type</span>
                                                </p>
                                                <div class="barcode">
                                            ...
                                            <div class="card-footer" style="position: absolute;bottom: 0;">
                                                <div class="del_status" id="del_div" style="background: #f06624;">
                                                    <h2 style="color: #fff;" id="del_status">STATUS</h2>
                                                </div>
                                                <div class="partners">
                                                    <div class="divider"></div>
                                                    <img src="<?=DN?>/img/torus-cube.png" style="width: 100%;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
