...
function showParticipantsList() {
    ...
    $('#paymentTable').DataTable({
        ...
        'ajax': {
            'url':linkto,
            'data': {type:type,subtype:subtype,status:status,payment_channel:payment_channel,country:country,datefrom:datefrom,dateto:dateto,request:"fetchParticitants"}
        },
        'columns': [
            { data: 'id' },
            { data: 'transaction_id' },
