...
$_GROUP_ID_ = Hash::decryptAuthToken(Input::get('groupId', 'get'));

$groupData  = DB::getInstance()->get('future_group_registration', array('id', '=', $_GROUP_ID_));
$_GROUP_EMAIL_ = $groupData->first()->email;

$adminData = DB::getInstance()->get('future_participants', array('email', '=', $_GROUP_EMAIL_));
$_GROUP_ADMIN_ID_ = $adminData->first()->id;

$_GROUP_DATA_ = FutureEventGroupController::getGroupByID($_EVENT_ID_ , $_GROUP_ID_ );
            ...
            <li class="nav-header">
                <div class="dropdown profile-element" style="padding-bottom: 30px;">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <span class="m-t-xs" style="margin-top: 7px;">
                            <strong class="font-bold"><?php echo $_GROUP_NAME_; ?> Group</strong>
                        </span>
                    </a>
                </div>
            </li>
            <li class="<?php echo ($page == "home" ? "active" : "")?>">
                <a href="https://apacongress.africa/"><i class="fa fa-home"></i> <span class="nav-label">Home </span></a>
            </li>
        </ul>
    ...
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li><a href="https://apacongress.africa/" style="color: #000a32;"><i class="fa fa-home"></i> Home</a></li>
            </ul>
            <img src="<?php linktoApac('img/apac-web-logo.png'); ?>" class="img-responsive" alt="logo" style="height: 80px;">
