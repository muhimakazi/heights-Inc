...
<body>
    <div id="wrapper">
                            ...
                            <form action="" id="filterForm" class="row" method='post'>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select id="hotel" name="hotel" onchange="filterOptionsRoom(this);"  class="form-control" data-rule="required" data-msg="Please select hotel">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select id="room" name="room"  class="form-control" data-rule="required" data-msg="Please select subtype">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <a href="<?=DN?>/hotel/export_bookings" class="btn btn-primary exportBtn" style="border-radius: 0px; padding: 6px 20px"><i class="fa fa-download"></i> Export</a>
                                </div>
                                <?php } ?>
                            </form>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content" id="participants-table">
                                <table id="bookingTable" class='table customTable'>
                                    <thead>
                                    <tr>
                                        <th> </th>
        ...
        <script src="<?=DN?>/pages/hotel/booking.js?v=<?=date('Y-m-d H:i:s')?>"></script>
